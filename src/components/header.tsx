...
export default function Header() {
  return (
    <header className="relative z-[999] [--x:0] sm:[--x:-50%]">
      <motion.div
        className=" fixed inset-x-0 top-0 h-[3.25rem] w-full rounded-none border border-white border-opacity-40 bg-white/80 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:left-1/2 sm:top-[1.5rem] sm:w-[36rem] sm:-translate-x-1/2 sm:rounded-full "
